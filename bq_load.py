...
final_output_path = "/home/airflow/gcs/data/merge_data_output.parquet"
...
def workshop_bash():
    ...
    จะทำการ load ข้อมูลเข้า BigQuery ด้วยคำสั่ง bash (bq_load) ผ่าน BashOperator
    ...
    t4 = BashOperator(
        task_id="bq_load",
        bash_command="bq load --source_format=PARQUET workshop.transaction gs://asia-southeast1-composer3-4c822d40-bucket/data/merge_data_output.parquet" ,
    )
